...
// 				<p className="text-main_3 border-b border-[#D9D9D9] pb-[19px] text-[26px] font-bold">
// 					서점ZIP
// 				</p>
// 			</div>
// 			<div className="flex w-full flex-col gap-[10px] px-[55px] pb-[15px]">
// 				<InputField type="email" placeholder="이메일을 입력해주세요" />
// 				<InputField type="pw" placeholder="비밀번호를 입력해주세요" />
...
// 				<span className="text-[14px] text-[#BCB3B3]">
// 					아직 회원이 아니신가요?
// 				</span>
// 				<span className="text-main_1 cursor-pointer text-[14px] underline">
// 					회원가입
// 				</span>
// 			</div>
// 		</div>
		...
		<div className="grid h-screen w-full place-items-center">
			<div className="flex w-full flex-col items-center">
				<div className="mb-[40px] items-center text-center">
					<img
						src={logo}
						className="mb-[-20px] ml-[-15px] h-[170px] w-[170px]"
					/>
					<p className="text-main_1 text-[15px] font-light">서점을 만나다</p>
					<p className="text-main_3 border-b border-[#D9D9D9] pb-[19px] text-[26px] font-bold">
						서점ZIP
