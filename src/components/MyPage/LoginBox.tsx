...
const LoginBox = () => {
  ...
  return (
    <div className="flex flex-col gap-[6px] rounded-[10px] border-[1px] border-mint pt-4">
      ...
      <div className="mt-4 grid grid-cols-[1fr_1px_1fr] items-center rounded-[10px] border-t-[1px] border-mint py-[9px]">
        <div className="flex items-center justify-center gap-1 text-body4 font-semibold text-white">
